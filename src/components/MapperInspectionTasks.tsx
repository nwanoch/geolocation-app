...
import MapperTaskModal from "./MapperTaskModal";
import InspecpectionModal from "./InspecpectionModal";
function MapperInspectionTasks() {
  return (
      ...
      <Box px="30px">
        ...
        >
          <Box w="70%" color="grey" textAlign="left">
            ...
            {/* <Text fontSize="12px">supervisor</Text> */}
...
export default MapperInspectionTasks;
